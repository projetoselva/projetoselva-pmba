      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link href="/auth/recuperar" className="text-emerald-600 hover:text-emerald-700">
              Esqueci a senha
            </Link>
          </div>
        ...
        <p className="text-center text-gray-500 mt-6">
          Não tem conta?{' '}
          <Link href="/auth/cadastro" className="text-emerald-600 font-medium hover:text-emerald-700">
            Criar conta grátis
          </Link>
        </p>
      </div>
